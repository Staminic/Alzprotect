...
<div class="contact<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Person">
	<div class="jumbotron mb-0 text-center">
		...
		<div class="hero-image none">
			<img
				src="/images/hero-images/tools-hero.jpg" alt="équipement de laboratoire" itemprop="image"
				srcset="/images/hero-images/tools-hero-lg.jpg 2400w,
								/images/hero-images/tools-hero-md.jpg 1984w,
								/images/hero-images/tools-hero-sm.jpg 1536w,
								/images/hero-images/tools-hero-xs.jpg 1152w"
				sizes="100vw"
			/>
		</div>
	</div>
	...
	<div class="container">
		<div class="contactform-body col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
